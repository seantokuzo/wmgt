...
const Loading: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div
        className={`w-40 h-40 ${
          pathname !== '/contact/thankyou' ? 'mt-20' : 'mt-8'
        } flex flex-col justify-center items-center border-4 border-white/[0.65] border-t-green-500 rounded-[50%] animate-loadspin`}
      >
